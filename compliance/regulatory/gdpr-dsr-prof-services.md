...
***Este ejemplo solo se proporciona con fines ilustrativos** _

John es un administrador de IT de un cliente empresarial de Office 365, con una interacción de soporte técnico abierta y dos interacciones cerradas. Ahora John está abandonando la compañía y quiere que se eliminen sus datos. John se pone en contacto con el Centro de respuesta de privacidad, que lo identifica como administrador de IT. Se le informa que su nombre no puede ser eliminado de las interacciones anteriores (cerradas), ni cualquier otro dato de las interacciones abiertas. Sin embargo, el Centro de respuesta de privacidad sustituirá a John como contacto en la interacción abierta actual si identifica un contacto de sustitución. John informa a Microsoft de que Jane será su contacto de sustitución y Microsoft realiza el cambio en todos los sistemas de soporte técnico.

## <a name="dsr-for-an-end-user-engaging-microsoft"></a>DSR para un usuario final que interactúa con Microsoft

_Cómo responde Microsoft a las solicitudes de los empleados de un cliente u otros sujetos de datos para ejercer sus derechos.*
...
_Cómo recibir asistencia de Microsoft cuando un cliente ha recibido una solicitud de su empleado u otros titulares de datos para ejercer sus derechos, y los datos personales de ese titular fueron recopilados por el Soporte técnico de Microsoft durante un contrato de soporte técnico,*

Cuando un cliente interacciona con el Soporte técnico de Microsoft, Microsoft recopila datos de soporte técnico del cliente para solucionar los problemas necesarios que requieren una interacción de soporte técnico. En estos datos de soporte técnico, se incluyen la interacción de Microsoft con el cliente (por ejemplo, chat, teléfono, correo electrónico, envío web), además de los archivos de contenido que el cliente envíe a Microsoft, o bien contenido que Microsoft haya extraído con el permiso del cliente del entorno de TI del cliente o del espacio empresarial de los servicios en línea para solucionar el problema de soporte técnico. En el caso del soporte técnico Premier, también se incluyen los datos que recopilamos del usuario para impedir de forma proactiva problemas futuros. Sin embargo, se excluye la información de contacto del cliente u otra información de la relación empresarial de Microsoft con el cliente (por ejemplo, registros de facturación).

Para todos los datos de soporte técnico, Microsoft es el procesador de datos. Como tal, Microsoft no responderá a solicitudes directas de derechos del titular de los datos en relación con los datos de soporte técnico proporcionados cuando se asociaron con un cliente comercial de Microsoft. Microsoft trabajará con el cliente mediante sus canales habituales de soporte técnico para ayudarle a responder a las solicitudes de derechos del titular de los datos.
...
*Opción B: Interacciones con clientes específicas.* Use los sistemas en línea para revisar incidencias, identifique interacciones específicas que contengan datos personales relevantes e informe de estas a Microsoft. Microsoft intentará proporcionar asistencia para realizar una búsqueda si el cliente no tiene la capacidad de buscar en los compromisos (entradas).

***Después de identificar las interacciones, solicite aplicar la solicitud de derechos del titular de los datos en una parte específica del registro o en todo lo relacionado con esa interacción en Microsoft.** _

Para identificar compromisos específicos, los clientes deben buscar en sus compromisos. En el caso de los clientes Premier, el Administrador de servicios contractuales ("CSM") de un cliente tiene visibilidad de todas las solicitudes de asistencia técnica (SR) creadas en virtud de ese programa de contratos. Para los clientes que no son Premier, hay disponibles portales de compromisos de asistencia equivalentes, como por ejemplo a través de las áreas de asistencia de Servicios en línea.
...
A todos los datos de Microsoft se les aplica una directiva de retención y eliminación, que variará en función del riesgo y otros factores.

Los clientes que soliciten la eliminación de los datos personales de un sujeto de datos de forma universal en todos los sistemas de soporte pueden hacerlo a través de su TAM o presentando una solicitud de soporte (SR) en el SMC o en un sistema equivalente. Usted _debe* indicar que se trata de una solicitud de asistencia para un DSR en el marco del GDPR.
...
### <a name="microsoft-support-data-transfer-and-management-tool-dtm-instructions"></a>Instrucciones para la herramienta Administración y transferencia de datos de soporte técnico de Microsoft (DTM)
...
Nota: los datos exportados no pueden incluir la propiedad intelectual de Microsoft ni ningún dato que pueda comprometer la seguridad o estabilidad del servicio.

***Este ejemplo solo se proporciona con fines ilustrativos** _

John es un CSM Premier para un cliente de Enterprise, Contoso, que usa O365 para el correo electrónico de sus empleados y Azure para alojar una Base de datos SQL de Contoso. Contoso tiene múltiples entradas abiertas y cerradas. Recientemente, el Soporte técnico de Microsoft, con el permiso de Contoso, movió una copia de la Base de datos SQL a DTM para soporte técnico y solución de problemas.
...
## <a name="dsr-guide-for-customer-provided-data-in-consulting-services-including-migration-services"></a>Guía DSR para los datos proporcionados por el cliente en los servicios de consultoría, incluyendo los servicios de migración

Cómo recibir asistencia de Microsoft cuando un cliente ha recibido una solicitud de su empleado u otros sujetos de datos para ejercer sus derechos, y los datos personales de ese sujeto de datos fueron recopilados por Microsoft durante un contrato de consultoría.*

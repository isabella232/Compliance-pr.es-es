...
- Escalaciones a cargo de operadores de servicios de Azure. Los empleados de Microsoft están preparados para identificar y escalar los posibles problemas de seguridad.
...
El equipo de respuesta de seguridad trabaja con el servicio de tratamiento de datos de Microsoft para que los ingenieros de seguridad y los SME de Windows Enterprise clasifiquen el evento en función de los datos reales de la evidencia. Un evento de seguridad puede ser clasificado como:
...
- **Infracción de privacidad**: subtipo de incidente de seguridad que implica datos personales. Los procedimientos de control no son diferentes de un incidente de seguridad.
...
El servicio de tratamiento de datos para el equipo de Windows Enterprise también puede optar por notificar al personal adicional de Microsoft, como el Servicio de atención al cliente (CSS) y el Administrador de cuentas (AM) o el Administrador técnico de cuentas (TAM) del cliente. Estas personas suelen tener relaciones estrechas con el cliente y pueden facilitar una corrección más rápida.

...
> [!NOTE]
> Aplicaciones de Microsoft 365 para empresas permite el acceso a varios servicios en la nube, como configuración de movilidad, licencias y almacenamiento en la nube de consumo de OneDrive, y puede permitir el acceso a servicios en la nube adicionales en el futuro. La configuración de movilidad y las licencias admiten los estándares de HITRUST. El almacenamiento en la nube para consumidores de OneDrive no lo hace y otros servicios en la nube accesibles a través de Aplicaciones de Microsoft 365 para empresas y que Microsoft puede ofrecer en el futuro tampoco admiten estos estándares.*
